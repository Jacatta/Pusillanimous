...
public class SpinWheel : MonoBehaviour {
    ...
    Currency_Level_Manager Currency_Man;
    pause PP;
    ...
    void Start () {
        Currency_Man = GameObject.FindObjectOfType<Currency_Level_Manager>();
    ...
    IEnumerator increaseDrag()
    {
       ...
       // Debug.Log("AV2: " + rb.angularVelocity);
        if (rb.angularVelocity > -40f) // Wheel is slowing
        {
