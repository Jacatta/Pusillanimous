  ...
  //  public Image Alert1;
    ...
    void OnParticleTrigger()
    {
        ...
        for (int i = 0; i < numEnter; i++)
        {
            ...
            GM.Alerts[ParticleIndexer].transform.position = new Vector3(p.position.x+20, GM.Alerts[ParticleIndexer].transform.position.y, GM.Alerts[ParticleIndexer].transform.position.z);
            ParticleIndexer++;
